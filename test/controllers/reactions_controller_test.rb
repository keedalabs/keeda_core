...
class ReactionsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create reaction" do
    assert_difference('Reaction.count') do
      post reactions_url, params: { reaction: { activity_id: @reaction.activity_id, object: @reaction.object, type: @reaction.type, user_id: @reaction.user_id } }
    end
  ...
  test "should update reaction" do
    patch reaction_url(@reaction), params: { reaction: { activity_id: @reaction.activity_id, object: @reaction.object, type: @reaction.type, user_id: @reaction.user_id } }

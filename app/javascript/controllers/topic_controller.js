...
/* This is the custom StimulusReflex controller for TopicReflex.
...
export default class extends ApplicationController {
   ...
   * Example:
   *
   *   <a href="#" data-reflex="TopicReflex#example">Example</a>
   *
   * Arguments:
   *
   ...
   *
   *   reflex - the name of the reflex e.g. "TopicReflex#example"
   *
